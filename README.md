...
![Build and deploy status badge](https://github.com/cipscis/code-blog/actions/workflows/build-and-deploy.yml/badge.svg)

[Code Blog](https://cipscis.github.io/code-blog/)

## Development

You will need to install [Node.js](https://nodejs.org/en/) before working on this project.

1. Clone the repository using `git clone https://github.com/cipscis/code-blog.git`.
